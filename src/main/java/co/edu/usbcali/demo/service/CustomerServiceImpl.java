...
public class CustomerServiceImpl implements CustomerService {
	...
	public void validate(Customer entity) throws Exception {
		...
		Set<ConstraintViolation<Customer>> constrainViolation=validator.validate(entity);
		
		if(constrainViolation.isEmpty()==false) {
			throw new ConstraintViolationException(constrainViolation);
		}
